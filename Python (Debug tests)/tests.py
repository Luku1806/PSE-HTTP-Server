...
cannon += Beam(
    ...
    request='GET / HTTP/1.1\r\nHost: intern\r\nAuthentication: Basic dGVzdDp0ZXN0dGVzdA==\r\n\r\n',
    response=['HTTP/1.1 200']
)
...
cannon += Beam(
    ...
    request='GET / HTTP/1.1\r\nHost: intern\r\nAuthentication: Basic dGVzdDE6dGVzdDF0ZXN0MQ==\r\n\r\n',
    response=['HTTP/1.1 200']
)
...
cannon += Beam(
    ...
    request='GET / HTTP/1.1\r\nHost: intern\r\nAuthentication: Basic aW52YWxpZDppbnRydWRlcg==\r\n\r\n',
    response=['HTTP/1.1 401']
)
...
cannon += Beam(
    ...
    request='GET / HTTP/1.1\r\nHost: intern\r\nAuthentication: test dGVzdDp0ZXN0dGVzdA==\r\n\r\n',
    response=['HTTP/1.1 401']
)
...
cannon += Beam(
    ...
    request='GET / HTTP/1.1\r\nHost: intern\r\nAuthentication: dGVzdDp0ZXN0dGVzdA==\r\n\r\n',
    response=['HTTP/1.1 401']
)
